...
def user_choice():
    ...
    user= str(input("Select what you want to play this round: piedra, papel, tijeras.\n"))
    user= user.lower()
    if user in options:
        return user
    else:
...
def run_game():
    ...
    while True:
        ...
        if (user == "tijeras" and computer == "papel") or (user == "piedra" and computer == "tijeras") or (user == "papel" and computer == "piedra"):
        ...
        if (computer == "tijeras" and user == "papel") or (computer == "piedra" and user == "tijeras") or (computer == "papel" and user == "piedra"):
